...
function App() {
  const [user, setUser] = useState({
    login: false, name: "", username: "", userId: "", description:{}, isPre_assesment:false,path:{},
  })
              ...
              get(userRef1)
                .then((snapshot) => {
                  ...
                  if (profileData) {
                    ...
                    setUser({ login: true, name: profileData.name, username: profileData.username ,userId:nodeName,description:profileData.description,path:profileData.path});
